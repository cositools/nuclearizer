...
if __name__ == "__main__": 
	...
	p = ArgumentParser(description="temporary tool to convert hdf5 files to roa files that can be read in rrby nuclearizer") 
	p.add_argument('--hdf', default=None, nargs='?',help = 'full path to hdf5 filename')
	p.add_argument('--save_dir',default=None,help='directory in which to save the roa file, defaults to hdf directory')
	p.add_argument('--save_name',default=None,help='file name for the roa file. Defaults to the same filename as the hdf file')
	...
	args = p.parse_args()
	hdf_to_roa(args.hdf, args.stripmap, args.save_dir,args.save_name,args.verbose,args.gz,args.side)
