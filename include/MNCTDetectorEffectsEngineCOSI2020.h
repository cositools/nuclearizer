/*
 * MMNCTDetectorEffectsEngineCOSI2020.h
 *
...
#ifndef __MMNCTDetectorEffectsEngineCOSI2020__
#define __MMNCTDetectorEffectsEngineCOSI2020__
...
class MNCTDetectorEffectsEngineCOSI2020
{
public:
  //! Default constructor
  MNCTDetectorEffectsEngineCOSI2020();
  //! Default destructor
  virtual ~MNCTDetectorEffectsEngineCOSI2020();
...
public:
  //! Tiny helper class for MNCTDetectorEffectsEngineCOSI2020 describing a special strip hit
...
//  map<MReadOutElementDoubleStrip, double> m_FSTNoise;
  ...
  #ifdef ___CLING___
public:
  ClassDef(MNCTDetectorEffectsEngineCOSI2020, 0) // no description
  #endif
};
