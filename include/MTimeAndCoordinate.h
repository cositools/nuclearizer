...
#ifndef __MTimeAndCoordinate__
#define __MTimeAndCoordinate__
...
class MTimeAndCoordinate
{
 ...
 public:
  ...
  //!
  MTimeAndCoordinate(double time, double MJDZero = c_UnixTimeMJD, double longitude = 0, double latitude = 0);

  //!
  virtual ~MTimeAndCoordinate();
...
#ifdef ___CLING___
 public:
  ClassDef(MTimeAndCoordinate, 0) // no description
#endif
