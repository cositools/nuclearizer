...
#ifndef __MModuleDepthCalibrationLinearPixel__
#define __MModuleDepthCalibrationLinearPixel__
...
class MModuleDepthCalibrationLinearPixel : public MModule
{
  // public interface:
 public:
  //! Default constructor
  ...
  //! Default destructor
  virtual ~MModuleDepthCalibrationLinearPixel();
  
  //! Create a new object of this class 
  virtual MModuleDepthCalibrationLinearPixel* Clone() { return new MModuleDepthCalibrationLinearPixel(); }
...
#ifdef ___CLING___
 public:
  ClassDef(MModuleDepthCalibrationLinearPixel, 0) // no description
#endif
