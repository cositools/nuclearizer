...
#ifndef __MMDetectorEffectsEngineSingleDet__
#define __MMDetectorEffectsEngineSingleDet__
...
class MDetectorEffectsEngineSingleDet
{
 public:
  //! Default constructor
  MDetectorEffectsEngineSingleDet();
  //! Default destructor
  virtual ~MDetectorEffectsEngineSingleDet();

  //! Set the simulation file name
  void SetSimulationFileName(const MString& FileName)
  {
  ...
  void SetDepthCalibrationTACCalFileName(const MString& FileName)
  {
    m_DepthCalibrationTACCalFileName = FileName;
  }
  //! Get the simulation file name
  MString GetSimulationFileName() const
  {
  ...
  MString GetDepthCalibrationTACCalFileName() const
  {
    return m_DepthCalibrationTACCalFileName;
  }

  //! Show the progress of simulation file reading
  void ShowProgressBar(bool Flag)
  {
    m_ShowProgressBar = Flag;
  }

  //! Set the roa file name
  void SetRoaFileName(const MString& FileName)
  {
    m_RoaFileName = FileName;
    m_SaveToFile = true;
  }
  //! Get the simulation file name
  MString GetRoaFileName() const
  {
    return m_RoaFileName;
  }
  ...
  {
    m_EnergyCalibrationFileName = FileName;
  }
  //! Set energy calibration file name
  MString GetEnergyCalibrationFileName() const
  {
    return m_EnergyCalibrationFileName;
  }

  //! Set threshold file name
  void SetThresholdFileName(const MString& FileName)
  {
    m_ThresholdFileName = FileName;
  }
  //! Set threshold file name
  MString GetThresholdFileName() const
  {
    return m_ThresholdFileName;
  }

  //! Set guard ring threshold file name
  void SetGuardRingThresholdFileName(const MString& FileName)
  {
    m_GuardRingThresholdFileName = FileName;
  }
  //! Get guard ring threshold file name
  MString GetGuardRingThresholdFileName() const
  {
    return m_GuardRingThresholdFileName;
  }

  //! Set the dead strips file name
  void SetDeadStripFileName(const MString& FileName)
  {
    m_DeadStripFileName = FileName;
  }
  //! Set the dead strips file name
  MString GetDeadStripFileName() const
  {
    return m_DeadStripFileName;
  }

  //! Set the charge sharing factors file name
  void SetChargeSharingFileName(const MString& FileName)
  {
    m_ChargeSharingFileName = FileName;
  }
  //! Get the charge sharing factors file name
  MString GetChargeSharingFileName() const
  {
    return m_ChargeSharingFileName;
  }

  //! Set the crosstalk coefficients file name
  void SetCrosstalkFileName(const MString& FileName)
  {
    m_CrosstalkFileName = FileName;
  }
  //! Get the crosstalk coefficients file name
  MString GetCrosstalkFileName() const
  {
    return m_CrosstalkFileName;
  }

  //! Set the charge loss coefficients file name
  void SetChargeLossFileName(const MString& FileName)
  {
    m_ChargeLossFileName = FileName;
  }
  //! Get the charge loss coefficients file name
  MString GetChargeLossFileName() const
  {
    return m_ChargeLossFileName;
  }

  //! Set the depth calibration coefficients file name
  void SetDepthCalibrationCoeffsFileName(const MString& FileName)
  {
    m_DepthCalibrationCoeffsFileName = FileName;
  }
  //! Set the depth calibration coefficients file name
  MString GetDepthCalibrationCoeffsFileName() const
  {
    return m_DepthCalibrationCoeffsFileName;
  }

  //!  Set the depth calibration splines file name
  void SetDepthCalibrationSplinesFileName(const MString& FileName)
  {
    m_DepthCalibrationSplinesFileName = FileName;
  }
  //!  Set the depth calibration splines file name
  MString GetDepthCalibrationSplinesFileName() const
  {
    return m_DepthCalibrationSplinesFileName;
  }

  //! Get include fudge factor
  bool GetApplyFudgeFactor() const
  {
    return m_ApplyFudgeFactor;
  }
  //! Set whether to include the fudge factor
  void SetApplyFudgeFactor(bool ApplyFudgeFactor)
  {
    m_ApplyFudgeFactor = ApplyFudgeFactor;
  }
