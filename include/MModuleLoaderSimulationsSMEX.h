/*
 * MModuleLoaderSimulationsSMEX.h
 *
...
#ifndef __MModuleLoaderSimulationsSMEX__
#define __MModuleLoaderSimulationsSMEX__
...
class MModuleLoaderSimulationsSMEX : public MModule, public MDetectorEffectsEngineSMEX
{
  // public interface:
 public:
  //! Default constructor
  ...
  //! Default destructor
  virtual ~MModuleLoaderSimulationsSMEX();
  
  //! Create a new object of this class 
  virtual MModuleLoaderSimulationsSMEX* Clone() { return new MModuleLoaderSimulationsSMEX(); }
...
#ifdef ___CLING___
 public:
  ClassDef(MModuleLoaderSimulationsSMEX, 0) // no description
#endif
