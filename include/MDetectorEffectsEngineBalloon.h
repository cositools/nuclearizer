/*
 * MMDetectorEffectsEngineBalloon.h
 *
...
#ifndef __MMDetectorEffectsEngineBalloon__
#define __MMDetectorEffectsEngineBalloon__
...
class MDetectorEffectsEngineBalloon
{
public:
  //! Default constructor
  MDetectorEffectsEngineBalloon();
  //! Default destructor
  virtual ~MDetectorEffectsEngineBalloon();
...
public:
  //! Tiny helper class for MDetectorEffectsEngineBalloon describing a special strip hit
  class MDEEStripHit
  {
  public:
    //! Default constructor
...
//  map<MReadOutElementDoubleStrip, double> m_FSTNoise;
  ...
  #ifdef ___CLING___
public:
  ClassDef(MDetectorEffectsEngineBalloon, 0) // no description
  #endif
};
