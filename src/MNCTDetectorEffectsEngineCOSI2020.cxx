/*
 * MNCTDetectorEffectsEngineCOSI2020.cxx
 *
 *
...
////////////////////////////////////////////////////////////////////////////////
//
// MNCTDetectorEffectsEngineCOSI2020
//
////////////////////////////////////////////////////////////////////////////////
...
#ifdef ___CLING___
ClassImp(MNCTDetectorEffectsEngineCOSI2020)
#endif
...
//! Default constructor
MNCTDetectorEffectsEngineCOSI2020::MNCTDetectorEffectsEngineCOSI2020()
{
  m_Geometry = nullptr;
  m_OwnGeometry = false;
...
bool MNCTDetectorEffectsEngineCOSI2020::Initialize()
{
	gRandom->SetSeed(0);
...
bool MNCTDetectorEffectsEngineCOSI2020::GetNextEvent(MReadOutAssembly* Event)
{
...
//! Finalize the module
bool MNCTDetectorEffectsEngineCOSI2020::Finalize()
{
...
int MNCTDetectorEffectsEngineCOSI2020::EnergyToADC(MNCTDEEStripHit& Hit, double mean_energy)
{  
...
double MNCTDetectorEffectsEngineCOSI2020::NoiseShieldEnergy(double energy, MString shield_name)
{ 
...
vector<double> MNCTDetectorEffectsEngineCOSI2020::ApplyChargeLoss(double energy1, double energy2, int detID, int side, double depth1, double depth2){
...
//! Calculate new summed energy of two strips affected by charge loss
bool MNCTDetectorEffectsEngineCOSI2020::InitializeChargeLoss()
{ 
...
bool MNCTDetectorEffectsEngineCOSI2020::ParseChargeSharingFile()
{
...
bool MNCTDetectorEffectsEngineCOSI2020::ParseCrosstalkFile()
{
...
//! Read in thresholds
bool MNCTDetectorEffectsEngineCOSI2020::ParseThresholdFile()
{
  MParser Parser;
...
bool MNCTDetectorEffectsEngineCOSI2020::ParseEnergyCalibrationFile()
{
  MParser Parser;
...
bool MNCTDetectorEffectsEngineCOSI2020::ParseDeadStripFile()
{  
...
void MNCTDetectorEffectsEngineCOSI2020::dummy_func(){
