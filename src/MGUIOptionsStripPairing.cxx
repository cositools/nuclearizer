...
void MGUIOptionsStripPairing::Create()
{
  ...
  m_Mode->SetSelected(dynamic_cast<MNCTModuleStripPairingGreedy_b*>(m_Module)->GetMode());
  m_Mode->Create();
...
bool MGUIOptionsStripPairing::OnApply()
{
  ...
  dynamic_cast<MNCTModuleStripPairingGreedy_b*>(m_Module)->SetMode(m_Mode->GetSelected());
