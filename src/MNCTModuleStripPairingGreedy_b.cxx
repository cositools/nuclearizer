...
//	cout << "SEED: " << seed << endl;
	...
	for (int i=0; i<n_x; i++){cout << xSig.at(i) << endl;}
...
bool MNCTModuleStripPairingGreedy_b::CheckAllStripsWerePaired(){
	...
	if (counter > nHitsOrig.at(0)+nHitsOrig.at(1)){
		cout << "there's something wrong with the code!" << endl;
		return false;
	}
	else if (counter == nHitsOrig.at(0)+nHitsOrig.at(1)){
		cout << "All strips were paired successfully!" << endl;
		return true;
	}
	else {
		cout << "Alert! Not all strips were paired!" << endl;
		return false;
	}
