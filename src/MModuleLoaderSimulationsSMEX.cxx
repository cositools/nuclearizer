/*
 * MModuleLoaderSimulationsSMEX.cxx
 *
 *
...
#ifdef ___CLING___
ClassImp(MModuleLoaderSimulationsSMEX)
#endif
...
MModuleLoaderSimulationsSMEX::MModuleLoaderSimulationsSMEX() : MModule()
{
  // Construct an instance of MModuleLoaderSimulationsSMEX

  // Set the module name --- has to be unique
  m_Name = "Simulation loader and detector effects engine for COSI SMEX";
  
  // Set the XML tag --- has to be unique --- no spaces allowed
  m_XmlTag = "XmlTagLoaderSimulationsSMEX";
...
MModuleLoaderSimulationsSMEX::~MModuleLoaderSimulationsSMEX()
{
  // Delete this instance of MModuleLoaderSimulationsSMEX
}
...
bool MModuleLoaderSimulationsSMEX::Initialize()
{
  // Initialize the module 

  MDetectorEffectsEngineSMEX::SetGeometry(MModule::m_Geometry);
  if (MDetectorEffectsEngineSMEX::Initialize() == false) {
    return false;
  }
...
bool MModuleLoaderSimulationsSMEX::AnalyzeEvent(MReadOutAssembly* Event) 
{
  ...
  if (MDetectorEffectsEngineSMEX::GetNextEvent(Event) == false) {
    m_IsFinished = true;
    return false;
  }
...
void MModuleLoaderSimulationsSMEX::Finalize()
{
  ...
  MDetectorEffectsEngineSMEX::Finalize();
}
...
void MModuleLoaderSimulationsSMEX::ShowOptionsGUI()
{
...
bool MModuleLoaderSimulationsSMEX::ReadXmlConfiguration(MXmlNode* Node)
{
...
MXmlNode* MModuleLoaderSimulationsSMEX::CreateXmlConfiguration() 
{
...
// MModuleLoaderSimulationsSMEX.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
