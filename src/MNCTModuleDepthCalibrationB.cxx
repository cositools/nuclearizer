...
#ifdef ___CLING___
ClassImp(MNCTModuleDepthCalibrationB)
#endif
...
MNCTModuleDepthCalibrationB::MNCTModuleDepthCalibrationB() : MModule()
{
  // Construct an instance of MNCTModuleDepthCalibrationB
...
MNCTModuleDepthCalibrationB::~MNCTModuleDepthCalibrationB()
{
  // Delete this instance of MNCTModuleDepthCalibrationB
}
...
bool MNCTModuleDepthCalibrationB::Initialize()
{
	...
	m_DepthCalibrator = new MNCTDepthCalibratorB();
...
bool MNCTModuleDepthCalibrationB::AnalyzeEvent(MReadOutAssembly* Event) 
{
...
MNCTStripHit* MNCTModuleDepthCalibrationB::GetDominantStrip(std::vector<MNCTStripHit*>& Strips, double& EnergyFraction){
...
int MNCTModuleDepthCalibrationB::CalculateLocalPosition(MNCTStripHit* XSH, MNCTStripHit* YSH, MVector& LocalPosition, MVector& PositionResolution, bool BadDepth){
...
void MNCTModuleDepthCalibrationB::ShowOptionsGUI()
{
...
bool MNCTModuleDepthCalibrationB::ReadXmlConfiguration(MXmlNode* Node)
{
...
MXmlNode* MNCTModuleDepthCalibrationB::CreateXmlConfiguration()
{
...
void MNCTModuleDepthCalibrationB::Finalize()
{
...
// MNCTModuleDepthCalibrationB.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
