...
const double MTimeAndCoordinate::c_Day2Second = 86400.;
const double MTimeAndCoordinate::c_Second2Day = 1./86400.;
const double MTimeAndCoordinate::c_MJDJD = 2400000.5; //constant for converting MJD to JD
const double MTimeAndCoordinate::c_UnixTimeMJD = 40587.0; //MJD when Unix time starts

const double MTimeAndCoordinate::c_TAI2TT = 32.184; //TT = TAI+32.184
const double MTimeAndCoordinate::c_LeapSeconds = 0.0; // Unix Time and GPS Time = UT + LeapSeconds
const double MTimeAndCoordinate::c_GAngle1 = 282.85; //J2000
const double MTimeAndCoordinate::c_GAngle2 = 62.9;
const double MTimeAndCoordinate::c_GAngle3 = -33.0;

const double MTimeAndCoordinate::c_RA_g = 192.85; //J2000 RA of Galactic North Pole in degrees
const double MTimeAndCoordinate::c_dec_g = 27.128333333; //J2000 dec of Galactic North Pole in degrees
const double MTimeAndCoordinate::c_dec_c = -28.929656275; //J2000 dec of Galactic Center in degrees



////////////////////////////////////////////////////////////////////////////////

MTimeAndCoordinate::MTimeAndCoordinate()
{
...
MTimeAndCoordinate::MTimeAndCoordinate(double time, double MJDZero, double longitude, double latitude):
...
double MTimeAndCoordinate::MJD_at_previous_midnight()
{
...
double MTimeAndCoordinate::Hours_since_previous_midnight()
{
...
double MTimeAndCoordinate::Equation_of_equinoxes_hours()
{
...
double MTimeAndCoordinate::GMST_hours()
{
...
double MTimeAndCoordinate::GAST_hours()
{
  double GAST_hr;
...
double MTimeAndCoordinate::GMST_degrees()
{
  double GMST_deg;
...
double MTimeAndCoordinate::GAST_degrees()
{
  double GAST_deg;
...
double MTimeAndCoordinate::LMST_degrees()
{
  double LMST_deg;
...
double MTimeAndCoordinate::LAST_degrees()
{
  double LAST_deg;
...
// MTimeAndCoordinate.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
