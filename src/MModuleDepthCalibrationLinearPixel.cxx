/*
 * MModuleDepthCalibrationLinearPixel.cxx
 *
 *
...
////////////////////////////////////////////////////////////////////////////////
//
// MModuleDepthCalibrationLinearPixel
//
////////////////////////////////////////////////////////////////////////////////
...
#ifdef ___CLING___
ClassImp(MModuleDepthCalibrationLinearPixel)
#endif
...
MModuleDepthCalibrationLinearPixel::MModuleDepthCalibrationLinearPixel() : MModule()
{
  // Construct an instance of MModuleDepthCalibrationLinearPixel
...
MModuleDepthCalibrationLinearPixel::~MModuleDepthCalibrationLinearPixel()
{
  // Delete this instance of MModuleDepthCalibration3rdPolyPixel
}
...
void MModuleDepthCalibrationLinearPixel::CreateExpos()
{
  // Create all expos
...
bool MModuleDepthCalibrationLinearPixel::Initialize()
{
...
bool MModuleDepthCalibrationLinearPixel::AnalyzeEvent(MReadOutAssembly* Event) 
{
  ...
  //cout << "MDepthCalibration3rdPolyPixel::AnalyzeEvent: Event ID = " << Event->GetID() << endl;
  ...
  for (unsigned int i_hit=0; i_hit<NHits; i_hit++) {
    ...
    MStripHit *SHX = nullptr, *SHY = nullptr;
  ...
  */
    ...
    if (Flag_CanBeCalibrated == 1 || Flag_CanBeCalibrated == 2 || NoTiming_Event == 1) {
      ...
      if (Flag_CanBeCalibrated != 0 && HasExpos() == true) {
...
void MModuleDepthCalibrationLinearPixel::ShowOptionsGUI()
{
...
bool MModuleDepthCalibrationLinearPixel::ReadXmlConfiguration(MXmlNode* Node)
{
...
MXmlNode* MModuleDepthCalibrationLinearPixel::CreateXmlConfiguration()
{
...
// MModuleDepthCalibrationLinearPixel.cxx: the end...
///////////////////////////////////////////////////////////////////////////////
