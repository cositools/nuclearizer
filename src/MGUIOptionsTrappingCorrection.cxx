...
void MGUIOptionsTrappingCorrection::Create()
{
  ...
  // m_SlowThresholdCutFixedValue = new MGUIEEntry(m_OptionsFrame, "Set threshold value [keV]:", false, dynamic_cast<MModuleTrappingCorrection*>(m_Module)->GetSlowThresholdCutFixedValue(), true, 0.0);
  ...
  // m_SlowThresholdCutFileSelector = new MGUIEFileSelector(m_OptionsFrame, "", dynamic_cast<MModuleTrappingCorrection*>(m_Module)->GetSlowThresholdCutFileName());
  ...
  // MSlowThresholdCutModes SlowThresholdCutMode = dynamic_cast<MModuleTrappingCorrection*>(m_Module)->GetSlowThresholdCutMode();
  ...
  // m_SlowThresholdCutNearestNeighborFixedValue = new MGUIEEntry(m_OptionsFrame, "Set threshold value [keV] for Nearest Neighbors:", false, dynamic_cast<MModuleTrappingCorrection*>(m_Module)->GetNearestNeighborThreshold());
  // m_OptionsFrame->AddFrame(m_SlowThresholdCutNearestNeighborFixedValue, RBOptionLayout);
  
  // MNearestNeighborCutModes NearestNeighborCutMode = dynamic_cast<MModuleTrappingCorrection*>(m_Module)->GetNearestNeighborCutMode();
...
// bool MGUIOptionsTrappingCorrection::ProcessMessage(long Message, long Parameter1, long Parameter2)
// {
...
// void MGUIOptionsTrappingCorrection::ToggleRadioButtons(int WidgetID)
// {
...
bool MGUIOptionsTrappingCorrection::OnApply()
{
 // Modify this to store the data in the module!
  ...
  //   dynamic_cast<MModuleTrappingCorrection*>(m_Module)->SetSlowThresholdCutMode(MSlowThresholdCutModes::e_Fixed);
  // }  if (m_SlowThresholdCutRBFile->GetState() == kButtonDown) {
  //   dynamic_cast<MModuleTrappingCorrection*>(m_Module)->SetSlowThresholdCutMode(MSlowThresholdCutModes::e_File);
  // }
  ...
  //   dynamic_cast<MModuleTrappingCorrection*>(m_Module)->SetNearestNeighborCutMode(MNearestNeighborCutModes::e_Ignore);
  // } else {
  //   dynamic_cast<MModuleTrappingCorrection*>(m_Module)->SetNearestNeighborCutMode(MNearestNeighborCutModes::e_Fixed);
  // }

  // dynamic_cast<MModuleTrappingCorrection*>(m_Module)->SetNearestNeighborThreshold(m_SlowThresholdCutNearestNeighborFixedValue->GetAsDouble());
