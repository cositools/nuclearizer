...
MAspect::MAspect()
{
  // Construct an instance of MAspect
...
MAspect::MAspect(const MAspect& Aspect)
{
  //! Copy constructor
...
MAspect::~MAspect()
{
  // Delete this instance of MAspect
}
...
const MAspect& MAspect::operator= (const MAspect& A) 
{ 
  m_Time = A.m_Time;
  m_Flag = A.m_Flag;
...
bool MAspect::StreamDat(ostream& S, int Version)
{
...
void MAspect::StreamEvta(ostream& S)
{
