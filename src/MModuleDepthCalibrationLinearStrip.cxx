/*
 * MModuleDepthCalibrationLinearStrip.cxx
 *
 *
...
#ifdef ___CLING___
ClassImp(MModuleDepthCalibrationLinearStrip)
#endif
...
MModuleDepthCalibrationLinearStrip::MModuleDepthCalibrationLinearStrip() : MModule()
{
  // Construct an instance of MModuleDepthCalibrationLinearStrip
...
MModuleDepthCalibrationLinearStrip::~MModuleDepthCalibrationLinearStrip()
{
  // Delete this instance of MModuleDepthCalibrationLinearStrip
}
...
bool MModuleDepthCalibrationLinearStrip::Initialize()
{
...
bool MModuleDepthCalibrationLinearStrip::AnalyzeEvent(MReadOutAssembly* Event) 
{
  // Main data analysis routine, which updates the event to a new level 

  unsigned int NHits = Event->GetNHits();
  bool DepthCalibrated = true;
  //mout << "MDepthCalibrationLinearStrip::AnalyzeEvent: Event ID = " << Event->GetID() << endl;
...
void MModuleDepthCalibrationLinearStrip::ShowOptionsGUI()
{
  // Show the options GUI - or do nothing
}


// MModuleDepthCalibrationLinearStrip.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
