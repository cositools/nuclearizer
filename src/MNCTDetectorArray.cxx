...
void MNCTDetectorArray::Activate()
{
  ...
  cout << m_AllDetectorVolumes.size() << " detector volumes has been found in geometry file...\n\n";
...
////////////////////////////////////////////////////////////////////////////////
bool MNCTDetectorArray::IsNCTDetector(const MDVolume* DetectorVolume)
{
  return (FindVolume(DetectorVolume)==0)?false:true;
}
...
////////////////////////////////////////////////////////////////////////////////
void MNCTDetectorArray::Load_Detector(string filename)
{
  char buffer[512];
  string sbuffer;
  Detector tmp_det;

  MString tmp_volumename;
  ...
  while(1)
  {
    ...
    if(buffer[0]!='#')
    {
      ...
      int DVindex=FindVolumeByName(tmp_volumename);
      if(DVindex!=-1)tmp_det.DetectorVolume = m_AllDetectorVolumes[DVindex];
      else cout << "Error:" << tmp_volumename << " not found!" << endl;
...
////////////////////////////////////////////////////////////////////////////////
void MNCTDetectorArray::Load_DeadStrip(string filename)
{
  char buffer[512];
  string sbuffer;
  MNCTStrip tmp_strip;
...
////////////////////////////////////////////////////////////////////////////////
void MNCTDetectorArray::Load_Coincidence(string filename)
{
  char buffer[512];
  string sbuffer;
...
////////////////////////////////////////////////////////////////////////////////
void MNCTDetectorArray::Load_AntiCoincidence(string filename)
{
  char buffer[512];
  string sbuffer;
  MNCTCoincidenceVolume tmp_coin;
...
void MNCTDetectorArray::DumpDetectors()
{
  ...
  for(unsigned int i=0; i<m_NCTDetectors.size(); i++)
  {
    cout << m_NCTDetectors[i].DetectorID << ' '
	 << m_NCTDetectors[i].DetectorVolume->GetName() << ' '
